...
```json title="Example: DiagonalGauss distribution"
{
        ...
        ...
            {
                ...
                "default_sigma":"gaussian_constraints_sigma",
                "dimensions":[
                    {"category":"nom_np_1","mean":"np_1", "sigma":"np_1_sigma"},
                    {"category":"nom_np_2","mean":"np_2"},
                    {"category":"nom_np_3","mean":"np_3", "sigma":31.622},
                ]
            }
        ...
    ],
    "data":[
        ...
        {
            ...
            "entries":[[0,0], [1,0], [2,0]],
            "axes":[
                {"name":"np", "categories":["nom_np_1","nom_np_2","nom_np_3"]},
